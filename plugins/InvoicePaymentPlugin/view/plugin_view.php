				...
				<table class="datadisplay dt-responsive" id="invoice_payments" cellspacing="0" width="100%">  
					<thead>  
						<tr>  
							...
							<th width="27%"><?php echo _('Note')?></th>
						</tr> 
					</thead>
...
<div id="add_payment">
	...
	echo '<form class="" id="InvoicePaymentPlugin__eventAjaxAddInvoicePayment" name="InvoicePaymentPlugin__eventAjaxAddInvoicePayment"  method="post">';
	...
	<div class="row">	
		<div class="col-md-12">
			...
			<div class="row">
				<div class="col-xs-4">
					<label class="control-label" for="ref_num"><?php echo _('Additional Note');?></label>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-8">
