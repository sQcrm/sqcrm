	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="box_content">
				...
				<p class="lead"><?php echo _('Manage different taxes.')?></p> 
			</div>
			<div class="datadisplay-outer">
				<div class="row">
					<div class="col-md-12">
						<h2><small><?php echo _('Product and Service Tax');?></small></h2>
						<div class="row " id="ps_add_block" style="margin-left:5px;">
						...
						<div id="ps_add_block_hidden" style="display:none;">
							<table class="datadisplay">  
								<tbody>
									<tr>
										<td><?php echo _('Tax name');?> : <input type="text" id="ps_add_tax_name" class="form-control input-sm"></td>
										<td><?php echo _('Tax value');?> : <input type="text" id="ps_add_tax_value" class="form-control input-sm"></td>
										<td>
											<br />
											<a href="#" onclick="cancel_save_tax('ps');" class="btn btn-default active"><i class="glyphicon glyphicon-remove-sign"></i><?php echo _('cancel');?></a>
			...
			<div class="datadisplay-outer">
				<div class="row">
					<div class="col-md-12">
						<h2><small><?php echo _('Shipping and Handling Tax');?></small></h2>
						<div class="row" id="sh_add_block" style="margin-left:5px;">
						...
						<div id="sh_add_block_hidden" style="display:none;">
							<table class="datadisplay">  
								<tbody>
									<tr>
										<td><?php echo _('Tax name');?> : <input type="text" id="sh_add_tax_name" class="form-control input-sm"></td>
										<td><?php echo _('Tax value');?> : <input type="text" id="sh_add_tax_value" class="form-control input-sm"></td>
										<td>
											<br />
											<a href="#" onclick="cancel_save_tax('sh');" class="btn btn-default active"><i class="glyphicon glyphicon-remove-sign"></i><?php echo _('cancel');?></a>
...
<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" id="delete_confirm_tax">
...
function edit_tax_inline_form(id,tax_type) {
	...
	$("#"+elm).find('td').each(function() {
		...
		if (td_id != tax_type+'_action_'+id) {
			...
			$(this).html('<input type="text" class="form-control input-sm" id="'+td_id+'_txt" value="'+val_split[0]+'">');
		} else {
			$(this).html('<a href="#" onclick="cancel_edit_inline('+id+',\''+tax_type+'\',\''+tax_name_val+'\',\''+tax_value_val[0]+'\')" class="btn btn-default active"><i class="glyphicon glyphicon-remove-sign"></i>'+CANCEL_LW+'</a>&nbsp;&nbsp;<a href="#" class="btn btn-primary" onclick="update_tax_data('+id+',\''+tax_type+'\')">'+SAVE_LW+'</a>');
		}
	})
}
...
function cancel_edit_inline(id,tax_type,tax_name_val,tax_value_val) {
	...
	$("#"+elm).find('td').each(function() {
		...
		if (td_id != tax_type+'_action_'+id) {
			...
			$(this).html('<a href="#" class="btn btn-primary btn-xs" onclick="edit_tax_inline_form('+id+',\''+tax_type+'\')"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;<a href="#" class="btn btn-primary btn-xs" onclick="return_delete_tax_confirm('+id+',\''+tax_type+'\')"><i class="glyphicon glyphicon-trash"></i></a>');
		}
	});
}
...
function update_tax_data(id,tax_type) {
	...
	$.ajax({
		...
		success:  function(html) {
			...
			$("#"+tax_type+"_action_"+id).html('<a href="#" class="btn btn-primary btn-xs" onclick="edit_tax_inline_form('+id+',\''+tax_type+'\')"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;<a href="#" class="btn btn-primary btn-xs" onclick="return_delete_tax_confirm('+id+',\''+tax_type+'\')"><i class="glyphicon glyphicon-trash"></i></a>');
		}
	});
}
