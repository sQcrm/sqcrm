...
/**
* Class FieldType141
* Field Type 141 : Organization Selector 
* @author Abhik Chakraborty
*/

class FieldType141 extends CRMFields {
	public $table = "fields";
	...
	*/
	public static function get_field_type() {
		return _('Organization Selector for inventory (Quotes/Invoice/SO/PO)') ;
	}
	...
	*/
	public static function display_field($name,$target_module,$value = '',$css = '') {
		...
		$html .='<input type="text" class = "'.$css.'" name="organization_'.$name.'" id="organization_'.$name.'" value="'.$display_val.'">';
		...
		if ($special_field === true) {
			...
			$html .=' var href = \'/popups/listdata_popup_modal?m=Organization&copy_org_address=yes&action=list&fielddisp=organization&target_module='.$target_module.'&fieldname='.$name.'\';';
		}
