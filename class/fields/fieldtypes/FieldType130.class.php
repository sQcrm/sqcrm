...
/**
* Class FieldType130
* Field Type 130 : Contacts Selector 
* @author Abhik Chakraborty
*/

class FieldType130 extends CRMFields {
	public $table = "fields";
	...
	*/
	public static function display_field($name,$value = '',$css = '') {
		...
		if ($special_field === true) {
			...
			$html .= 'var href = \'/popups/listdata_popup_modal?m=Contacts&action=list&fielddisp=contact&fieldname='.$name.'\';';
		}
		$html .=  
			"\n".' 
			if (href.indexOf(\'#\') == 0) {
