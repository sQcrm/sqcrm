...
class BaseObject {
	public $objErrorId = 0;
	public $objErrorDesc  = "";
	public $objErrorFile = "radria_errors.log" ;
	public $objLogRunFile = "radria_run.log";
	public $objLogFilesPath = "./";
	public $objLogErrors = true ;
	public $objLogRun = true;
	public $objDisplayErrors = true ;
	public $objDisplayRunLog = false ;
	...
	*/
	function save($objectname, $destination="", $ttl=1400) {
		...
		if (empty($destination)) {
			...
			//$db_con = $this->setDbConnection($this->dbcon);
			//$result = $this->result ;
			unset($this->dbcon);
			unset($this->result);
			...
			//$_SESSION[$objectname]->dbcon = $db_con ;
			//$_SESSION[$objectname]->result = $result ;
			return true;
		}
	}
