...
class Invoice extends DataObject {
	...
	*/
	public function eventAddRecord(EventControler $evctl) { 
		$permission = $_SESSION["do_crm_action_permission"]->action_permitted('add',15) ; 
		if (true === $permission) {
	...
	*/
	public function eventEditRecord(EventControler $evctl) {
		...
		if ($id_entity > 0 && true === $_SESSION["do_crm_action_permission"]->action_permitted('edit',15,(int)$evctl->sqrecord)) {
