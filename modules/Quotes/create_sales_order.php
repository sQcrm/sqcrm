...
$do_block = new Block();
$do_block->get_block_by_module(14);//-- get block information for sales order
...
$module_obj->so_billing_country = $module_obj->q_billing_country;
$module_obj->so_shipping_country = $module_obj->q_shipping_country;
...
$module_id = 14;
require_once('view/create_salesorder_from_quote_view.php');
?>