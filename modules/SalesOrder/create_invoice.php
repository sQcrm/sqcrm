...
//-- get lineitems for sales order
$do_lineitems = new Lineitems();
$do_lineitems->get_line_items(14,$sqcrm_record_id);

//update the properties
$module_obj->terms_condition = $tems_condition;
$module_obj->inv_billing_address = $module_obj->so_billing_address;
$module_obj->inv_shipping_address = $module_obj->so_shipping_address;
$module_obj->inv_billing_po_box = $module_obj->so_billing_po_box;
$module_obj->inv_shipping_po_box = $module_obj->so_shipping_po_box;
$module_obj->inv_billing_po_code = $module_obj->so_billing_po_code;
$module_obj->inv_shipping_po_code = $module_obj->so_shipping_po_code;
$module_obj->inv_billing_city = $module_obj->so_billing_city;
$module_obj->inv_shipping_city = $module_obj->so_shipping_city;
$module_obj->inv_billing_state = $module_obj->so_billing_state;
$module_obj->inv_shipping_state = $module_obj->so_shipping_state;
$module_obj->inv_billing_country = $module_obj->so_billing_country;
$module_obj->inv_shipping_country = $module_obj->so_shipping_country;
...
if (isset($_GET["return_page"]) && $_GET["return_page"] != '') {
	...
	$cancel_return = NavigationControl::getNavigationLink('SalesOrder',$return,$sqcrm_record_id);
} else {
...
$module_id = 15;
require_once('view/create_invoice_from_salesorder_view.php');
?>