	...
	<div style = "float:left;margin-right:20px;">
		...
		<div id="cf_data" >
			...
			<div id="" style="display:block;">
				...
				echo _('Label :');
				?>
				<input type="text" name="cf_label_ed" id="cf_label_ed" value="<?php echo $do_custom_fields->field_label;?>">
            </div>
            <?php
			...
			<div id="cf_max_len_div_ed" <?php echo $cf_max_len_div_ed_style; ?> ><br />
				...
				echo _('Max Length');
				?>
				<input type="text" name="cf_max_len_ed" id="cf_max_len_ed" value="<?php echo $field_validation_data["maxlength"]?>">
            </div>
            ...
            <div id="cf_min_len_div_ed" <?php echo $cf_min_len_div_ed_style; ?> >
				...
				echo _('Min Length');
				?>
				<input type="text" name="cf_min_len_ed" id="cf_min_len_ed" value="<?php echo $field_validation_data["minlength"]?>" >
            </div>
            ...
            <div id="" style="display:block;">
				...
				echo _('Values');
				?>
				<textarea name="cf_pick_ed" id="cf_pick_ed" cols=7 rows=6><?php echo $pick_data; ?></textarea>
            </div>
            <?php 
            } 
            ?>
            ...
            <div id="cf_pick_notequal_ed_div" <?php echo $cf_pick_notequal_ed_div_style ; ?> >
				...
				echo _('Not Equal :')
				?>
				<input type="text" name="cf_pick_notequal_ed" id="cf_pick_notequal_ed" size=5 value="<?php echo $field_validation_data["notEqual"];?>">
            </div>
		</div>
	</div>
</div>
