...
echo '<form class="form-horizontal" id="CustomFields__eventAddCustomField" name="CustomFields__eventAddCustomField" action="/eventcontroler.php" method="post">';
echo $e_add->getFormEvent();
?>
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal">x</button>
    <h3><?php echo _('Add a new custom field')?></h3>
</div>
    ...
    <div style = "float:left;margin-left:240px;position:absolute;margin-right:20px;">
        ...
        <div id="cf_data" >
            ...
            <div id="cf_label_div" style="display:none;">
				...
				echo _('Label :');
				?>
				<input type="text" name="cf_label" id="cf_label">
            </div>
            ...
            <div id="cf_len_div" style="display:none;"><br />
				...
				echo _('Length :');
				?>
				<input type="text" name="cf_len" id="cf_len" size=5>
            </div>
            <div id="cf_max_len_div" style="display:none;"><br />
				<?php 
				echo _('Max Length');
				?>
				<input type="text" name="cf_max_len" id="cf_max_len">
            </div>
            ...
            <div id="cf_min_len_div" style="display:none;"><br />
				...
				echo _('Min Length');
				?>
				<input type="text" name="cf_min_len" id="cf_min_len">
            </div>
            ...
            <div id="cf_pick_div" style="display:none;"><br />
				...
				echo _('Values');
				?>
				<textarea name="cf_pick" id="cf_pick" cols=7 rows=6></textarea>
            </div>
            <div id="cf_pick_notequal_div" style="display:none;"><br />
				<?php
				echo _('Not Equal :')
				?>
				<input type="text" name="cf_pick_notequal" id="cf_pick_notequal" size=5>
            </div>
		</div>
	</div>
</div>
